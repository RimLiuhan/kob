                        ...
                        <div class="modal-dialog modal-xl">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea v-model="botadd.description"  class="form-control" id="add-bot-description" placeholder="请输入Bot简介"/>
                                </div>
                                <div class="mb-3">
                                        ...
                                        <td>
                                            ...
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="add-bot-description" class="form-label">简介</label>
                                                        <textarea v-model="bot.description"  class="form-control" id="add-bot-description" placeholder="请输入Bot简介"/>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="add-bot-code" class="form-label">代码</label>
                                                        <VAceEditor
...
export default {
    ...
    "https://cdn.jsdelivr.net/npm/ace-builds@" + require('ace-builds').version + "/src-noconflict/")
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app7466.acapp.acwing.com.cn/api/user/bot/add/",
                type: "post",
                data: {
                    title: botadd.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app7466.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "post",
                data: {
                    bot_id: bot.id
                },
        ...
        const update_bot = (bot) => {
            bot.error_message = "";
            $.ajax({
                url: "https://app7466.acapp.acwing.com.cn/api/user/bot/update/",
                type: "post",
                data: {
                    bot_id: bot.id,
                    title: bot.title,
